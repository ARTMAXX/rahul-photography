...
export default function About() {
  ...
  return (
    <section
      id="about"
      ref={containerRef}
      className="relative w-full bg-black text-white min-h-screen z-40"
      style={{ padding: "45vh 4rem 40vh" }}
    >
      {/* Floating scroll indicator (34) - matches reference */}
      <div className="absolute left-8 top-1/2 -translate-y-1/2 text-xs font-sans text-neutral-500 hidden md:block z-20">
        (34)
      </div>
